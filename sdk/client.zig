...
fn copyOCRResult(allocator: std.mem.Allocator, result: runtime_types.ExecutionResult) !OCRResult {
    ...
    return .{
        ...
        .vision_block_depth = parsed.value.vision_block_depth,
        .patch_embedding_dim = parsed.value.patch_embedding_dim,
        .patch_embedding_executed = parsed.value.patch_embedding_executed,
        .visual_position_dim = parsed.value.visual_position_dim,
        .visual_position_embedding_executed = parsed.value.visual_position_embedding_executed,
        ...
        .visual_attention_blocks_executed = parsed.value.visual_attention_blocks_executed,
        .visual_block_dim = parsed.value.visual_block_dim,
        .visual_block_mlp_executed = parsed.value.visual_block_mlp_executed,
        .visual_mlp_blocks_executed = parsed.value.visual_mlp_blocks_executed,
        ...
        .decoded_token_count = parsed.value.decoded_token_count,
