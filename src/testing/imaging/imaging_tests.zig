...
test "inspectWebpVp8l parses transform chain for lossless samples" {
    ...
    try testing.expectEqual(@as(usize, 52), rgb_info.transforms[0].subimage_header.?.header_end_bit_pos);
    ...
    try testing.expectEqual(@as(usize, 52), rgba_info.transforms[0].subimage_header.?.header_end_bit_pos);
