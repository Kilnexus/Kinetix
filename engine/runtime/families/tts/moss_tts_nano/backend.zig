...
fn execute(
    ...
    const receipt = Receipt{
        ...
        .onnx_metadata_supported_node_count = state.onnx_metadata.supported_node_count,
        .onnx_metadata_unsupported_node_count = state.onnx_metadata.unsupported_node_count,
        .onnx_metadata_unsupported_ops = state.onnx_metadata.unsupported_ops[0..state.onnx_metadata.unsupported_op_entry_count],
