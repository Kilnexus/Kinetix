...
test "auto kv cache scheme resolves by backend name" {
    try std.testing.expectEqual(Scheme.bf16, resolveScheme(.auto, "bf16"));
    try std.testing.expectEqual(Scheme.q8, resolveScheme(.auto, "q8"));
}
