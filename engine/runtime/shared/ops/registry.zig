...
pub const entries = [_]Entry{
    .{ .name = "Constant", .domain = .onnx_graph, .status = .graph_executable, .module = "shared/graph/runtime/ops/core.zig" },
    .{ .name = "Identity", .domain = .onnx_graph, .status = .graph_executable, .module = "shared/graph/runtime/ops/core.zig" },
    ...
    .{ .name = "SwiGLU", .domain = .onnx_graph, .status = .graph_executable, .module = "shared/graph/runtime/ops/activation.zig" },
    ...
    .{ .name = "Reshape", .domain = .onnx_graph, .status = .graph_executable, .module = "shared/graph/runtime/ops/shape.zig" },
    .{ .name = "Shape", .domain = .onnx_graph, .status = .graph_executable, .module = "shared/graph/runtime/ops/shape.zig" },
    .{ .name = "Unsqueeze", .domain = .onnx_graph, .status = .graph_executable, .module = "shared/graph/runtime/ops/shape.zig" },
    .{ .name = "Squeeze", .domain = .onnx_graph, .status = .graph_executable, .module = "shared/graph/runtime/ops/shape.zig" },
    .{ .name = "Concat", .domain = .onnx_graph, .status = .graph_executable, .module = "shared/graph/runtime/ops/shape.zig" },
    .{ .name = "Transpose", .domain = .onnx_graph, .status = .graph_executable, .module = "shared/graph/runtime/ops/shape.zig" },
    .{ .name = "Gather", .domain = .onnx_graph, .status = .graph_executable, .module = "shared/graph/runtime/ops/indexing.zig" },
    ...
    .{ .name = "Conv", .domain = .onnx_graph, .status = .graph_executable, .module = "shared/graph/runtime/ops/spatial.zig" },
    .{ .name = "MaxPool", .domain = .onnx_graph, .status = .graph_executable, .module = "shared/graph/runtime/ops/spatial.zig" },
    ...
    .{ .name = "CopyTensorBlock", .domain = .vision_nn, .status = .native_kernel, .module = "vision/nn/ops/layout.zig" },
    .{ .name = "MaxPool2d", .domain = .vision_nn, .status = .native_kernel, .module = "vision/nn/ops/pooling.zig" },
    .{ .name = "MatMul", .domain = .vision_nn, .status = .native_kernel, .module = "vision/nn/ops/linalg.zig" },
    .{ .name = "SoftmaxRows", .domain = .vision_nn, .status = .native_kernel, .module = "vision/nn/ops/linalg.zig" },
    .{ .name = "Conv2d", .domain = .vision_nn, .status = .native_kernel, .module = "vision/nn/ops/conv.zig" },
    .{ .name = "Conv2dGeneral", .domain = .vision_nn, .status = .native_kernel, .module = "vision/nn/ops/conv/kernel_general.zig" },
    .{ .name = "Conv2d3x3Pad1", .domain = .vision_nn, .status = .native_kernel, .module = "vision/nn/ops/conv/kernel_3x3.zig" },
    .{ .name = "Conv2dPointwise", .domain = .vision_nn, .status = .native_kernel, .module = "vision/nn/ops/conv/kernel_pointwise.zig" },
    .{ .name = "Conv2dPointwiseConcat", .domain = .vision_nn, .status = .native_kernel, .module = "vision/nn/ops/conv/kernel_pointwise.zig" },

    .{ .name = "Dot", .domain = .text_core, .status = .native_kernel, .module = "text/core/cpu.zig" },
    .{ .name = "AxpyInPlace", .domain = .text_core, .status = .native_kernel, .module = "text/core/cpu.zig" },
    .{ .name = "MatMulVec", .domain = .text_core, .status = .native_kernel, .module = "text/core/cpu.zig" },
    .{ .name = "RmsNorm", .domain = .text_core, .status = .native_kernel, .module = "text/core/cpu.zig" },
    .{ .name = "LayerNorm", .domain = .text_core, .status = .native_kernel, .module = "text/core/cpu.zig" },
    .{ .name = "RmsNormRepeated", .domain = .text_core, .status = .native_kernel, .module = "text/core/cpu.zig" },
    .{ .name = "SiLU", .domain = .text_core, .status = .native_kernel, .module = "text/core/cpu.zig" },
    .{ .name = "GELU", .domain = .text_core, .status = .native_kernel, .module = "text/core/cpu.zig" },
    .{ .name = "SwiGLU", .domain = .text_core, .status = .native_kernel, .module = "text/core/cpu.zig" },
    ...
    .{ .name = "ScaledDotProductAttentionSingleQueryQ8CachePagedHeadMajor", .domain = .text_attention, .status = .native_kernel, .module = "text/attention/q8_cache.zig" },
    .{ .name = "DotQ8GroupedSlice", .domain = .text_attention, .status = .native_kernel, .module = "text/attention/q8_cache.zig" },
    .{ .name = "AxpyQ8GroupedSliceInPlace", .domain = .text_attention, .status = .native_kernel, .module = "text/attention/q8_cache.zig" },
    ...
    .{ .name = "EncodeQ8Row", .domain = .text_quantized, .status = .native_kernel, .module = "text/quantized/kernels.zig" },
    .{ .name = "EncodeQ6Row", .domain = .text_quantized, .status = .native_kernel, .module = "text/quantized/kernels.zig" },
    .{ .name = "EncodeQ4Row", .domain = .text_quantized, .status = .native_kernel, .module = "text/quantized/kernels.zig" },
    .{ .name = "DecodeQ8Row", .domain = .text_quantized, .status = .native_kernel, .module = "text/quantized/kernels.zig" },
    .{ .name = "DecodeQ6Row", .domain = .text_quantized, .status = .native_kernel, .module = "text/quantized/kernels.zig" },
    .{ .name = "DecodeQ4Row", .domain = .text_quantized, .status = .native_kernel, .module = "text/quantized/kernels.zig" },
    .{ .name = "DotQ8Row", .domain = .text_quantized, .status = .native_kernel, .module = "text/quantized/kernels.zig" },
    .{ .name = "DotQ6Row", .domain = .text_quantized, .status = .native_kernel, .module = "text/quantized/kernels.zig" },
    .{ .name = "DotQ4Row", .domain = .text_quantized, .status = .native_kernel, .module = "text/quantized/kernels.zig" },
    .{ .name = "MatMulQ8Rows", .domain = .text_quantized, .status = .native_kernel, .module = "text/quantized/kernels.zig" },
    .{ .name = "MatMulQ6Rows", .domain = .text_quantized, .status = .native_kernel, .module = "text/quantized/kernels.zig" },
    .{ .name = "MatMulQ4Rows", .domain = .text_quantized, .status = .native_kernel, .module = "text/quantized/kernels.zig" },
